...
public class ProfileCompositeTest extends AbstractValidatorTest {
	
	public static final URL URL_TEST_COMPOSITE = TestConfig.getCompositionTestProfileURL();

	protected Profile addCompositeProfile;
	...
	public void registerProfile() throws IOException, InvalidProfileException {
		...
		this.addCompositeProfile = pm.registerProfile(URL_TEST_COMPOSITE);
	}
	...
	public void testSchemas() throws IOException, InvalidProfileException {
		...
		c.setProfile(this.addCompositeProfile);
	...
	public void testSchemasAndStylesheets() throws IOException, InvalidProfileException {
		...
		assertEquals(3, c.getEventsList().size());
