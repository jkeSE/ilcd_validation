...
public class ProfileBaseTest extends AbstractValidatorTest {

	protected final Logger log = org.apache.logging.log4j.LogManager.getLogger(this.getClass());

	public static final URL URL_TEST_BASE = TestConfig.getBaseTestProfileURL();

	protected Profile baseProfile;
	...
	public void registerProfile() throws IOException, InvalidProfileException {
		...
		this.baseProfile = pm.registerProfile(URL_TEST_BASE);
	}
	...
	public void testSchemasAndStylesheets() throws IOException, InvalidProfileException {
		...
		assertEquals(1, c.getEventsList().size());
